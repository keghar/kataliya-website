...
const navigation = {
  main: [{ name: "Blog", href: "/categories" }],
      ...
      <div className="pb-0" id="sign-up">
        <div className="mx-auto ">
          <div className="relative mx-auto isolate overflow-hidden  inset-0   px-6 py-10 sm:px-24 xl:py-32 bg-gradient-to-b from-white to-[#9e82f6]">
            ...
            <form className="mx-auto my-10 flex max-w-md gap-x-4 bg-white rounded-full border border-purple-700 item-center">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-slate-800 shadow-sm ring-1 ring-inset ring-white/10 focus:ring-1 focus:ring-inset focus:ring-purple-900/10 sm:text-sm sm:leading-6 outline-purple-900/50"
            ...
            <footer className="mx-auto max-w-7xl overflow-hidden px-6 py-8 lg:px-8">
              <nav
                ...
                {navigation.main.map((item) => (
                  <div key={item.name} className="pb-6">
                    <a
                      href={item.href}
                      className="text-sm leading-6 text-slate-800 hover:text-gray-900">
                      {item.name}
                    </a>
                  </div>
                ))}
