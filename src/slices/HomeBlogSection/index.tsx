        ...
        <div className="relative w-full max-w-7xl bg-white">
          ...
          <div className="bg-white">
            <Tabs defaultValue="recent" className="w-full ">
              <TabsList className="mx-auto grid grid-cols-2 md:grid-cols-4 text-center bg-slate-100 rounded-lg ">
                <TabsTrigger
                  value="recent"
                  className=" border-slate-400  focus:border border-0 py-4 hover:bg-slate-200 rounded-lg focus:text-purple-500">
                  Recent Blogs
                </TabsTrigger>
                <TabsTrigger
                  value="business"
                  className=" border-slate-400 focus:border border-0 hover:bg-slate-200 rounded-lg focus:text-purple-500">
                  Business
                </TabsTrigger>
                <TabsTrigger
                  value="real-estate"
                  className="focus:border border-slate-400 border-0  hover:bg-slate-200 rounded-lg py-4 focus:text-purple-500">
                  Real Estate
                </TabsTrigger>
                <TabsTrigger
                  value="health"
                  className="hover:bg-slate-200 focus:border border-0 border-slate-400 focus:text-purple-500 rounded-lg">
                  Health
                </TabsTrigger>
              </TabsList>
